{{-- ✅ المسار: resources/views/auth/passwords/confirm.blade.php --}}
<!DOCTYPE html>
...
<head>
    ...
    <title>{{ __('Confirm Password') }} - {{ config('app.name', '4ayab') }}</title>
                    ...
                    <div class="card confirm-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center mb-4">
                                <p class="text-muted">
                                    ...
                                    {{ __('هذه منطقة محمية، يرجى تأكيد كلمة المرور للمتابعة') }}
                                </p>
                            </div>
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-8 offset-md-4 d-flex flex-column gap-2">
                                        <button type="submit" class="btn btn-primary btn-block">
                                            <i class="fas fa-check-circle me-2"></i> {{ __('تأكيد والمتابعة') }}
                                        </button>

                                        @if (Route::has('password.request'))
                                            <a class="btn btn-link text-center" href="{{ route('password.request') }}">
                                                <i class="fas fa-key me-1"></i> {{ __('نسيت كلمة المرور؟') }}
                                            </a>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="card-footer">
                            <div class="text-muted small">
                                ...
                                {{ __('لحماية حسابك، نطلب تأكيد كلمة المرور بشكل دوري') }}
                            </div>
                        </div>
                    </div>
